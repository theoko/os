...
.PHONY: all build kernel arm64-kernel iso arm64-iso iso-arm64 bridge bridge-run run run-arm64 run-bridged run-best utm utm-run utm-bridged usb usb-list drive linux-vm refresh refresh-install refresh-uninstall test test-all test-host smoke smoke-arm64 smoke-bridge clean distclean
